<?php
?>
<div id="outerslider" style="margin-top: -39px;">
        ...
        <section id="slider">
            <div id="layerslider" class="slideritems">
                <div class="ls-layer" id="ls-layer-1" data-rel="slidedelay: 3000;delayout: 750;">
                    ...
                    <img class="ls-s2" id="ls-s2-1" src="<?php echo Yii::getAlias('@web')?>/estore/images/content/sample-1.png" alt="sample-1" title="New Arrival for Electronics" style="durationin: 2000; easingin: easeOutExpo; slidedirection: bottom; delayin: 1000" />
                ...
                <div class="ls-layer" id="ls-layer-2" data-rel="slidedelay: 3000;delayout: 750;">
                    ...
                    <img class="ls-s2" id="ls-s2-2" src="<?php echo Yii::getAlias('@web')?>/estore/images/content/sample-2.png" alt="sample-2" title="New Arrival for Furnitures" style="durationin: 2000; easingin: easeOutExpo; slidedirection: bottom; delayin: 1000" />
                ...
                <div class="ls-layer" id="ls-layer-3" data-rel="slidedelay: 3000;delayout: 750;">
                    ...
                    <img class="ls-s2" id="ls-s2-3" src="<?php echo Yii::getAlias('@web')?>/estore/images/content/sample-3.png" alt="sample-3" title="New Arrival for Accessories" style="durationin: 2000; easingin: easeOutExpo; slidedirection: bottom; delayin: 1000" />
